...
\input{APIv4.datamodel/cdns}
\input{APIv4.datamodel/cache.groups}
\input{APIv4.datamodel/cache.servers}
\input{APIv4.datamodel/capabilities}
\input{APIv4.datamodel/delivery.services}
\input{APIv4.datamodel/global.configuration}
\input{APIv4.datamodel/infrastructure.servers}
\input{APIv4.datamodel/invalidation.jobs}
\input{APIv4.datamodel/origins}
\input{APIv4.datamodel/profiles}
\input{APIv4.datamodel/physical.locations}
\input{APIv4.datamodel/roles}
\input{APIv4.datamodel/tags}
\input{APIv4.datamodel/tenants}
\input{APIv4.datamodel/topologies}
\input{APIv4.datamodel/traffic.monitors}
\input{APIv4.datamodel/traffic.ops.servers}
\input{APIv4.datamodel/traffic.portals}
\input{APIv4.datamodel/traffic.routers}
\input{APIv4.datamodel/traffic.stats.servers}
\input{APIv4.datamodel/traffic.vaults}
\input{APIv4.datamodel/users}
