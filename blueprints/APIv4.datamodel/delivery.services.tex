...
\footnote{The Miss Location of a Delivery Service is uneditable by users that
do not have the \code{delivery-service-miss-location} Permission (as well as
any other Permission(s) required by the endpoint used for editing).}
...
%TODO: MSO use-case?
\paragraph{Origin}
A Delivery Service's Origin of content is represented by an unsigned integer
that is the ID the Origin.
