...
func (r Route) String() string {
	return fmt.Sprintf("path=%s method=%s version=%d.%d", r.Path, r.Method, r.Version.Major, r.Version.Minor)
}
...
func CreateRouteMap(rs []Route, rawRoutes []RawRoute, authBase middleware.AuthBase, reqTimeOutSeconds int) (map[string][]PathHandler, map[api.Version]struct{}) {
